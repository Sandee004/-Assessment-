...
#cursor.execute("CREATE TABLE agentname (name_id int(11), firstname varchar(255), lastname varchar(255), email varchar(255) DEFAULT " ", phone char(13), pollingunit_uniqueid int(11), PRIMARY KEY (name_id))")
#cursor.execute("INSERT INTO  agentname VALUES('1', 'Christian', 'Emenike', 'christian@bincom.net', '08034699500', '1')")
#cursor.execute("INSERT INTO agentname VALUES ('2', 'Ngozi', 'Emenike', 'biggysmalls@home.net', '08089003444', '2')")
#cursor.execute("INSERT INTO agentname VALUES ('3', 'Chinyere', 'Emenike', 'chinyere@emenike.net', '07034532310', '1')")
#cursor.execute("INSERT INTO agentname VALUES ('4', 'Chimezie', 'Emenike', 'chimezie@emenike.net', '07034532322', '2')")

#cursor.execute("CREATE TABLE announced_lga_results (result_id int(11), lga_name varchar(50), party_abbreviation char(4), party_score int(11), entered_by_user varchar(50), date_entered datetime, user_ip_address varchar(50), PRIMARY KEY (result_id))")
"""records1= [
...
cursor.executemany("INSERT INTO announced_lga_results VALUES(?, ?, ?, ?, ?, ?, ?);",records1)"""

"""
cursor.execute("CREATE TABLE announced_pu_results ( result_id int(11), polling_unit_uniqueid varchar(50), party_abbreviation char(4), party_score int(11), entered_by_user varchar(50), date_entered datetime NOT " ", user_ip_address varchar(50) NOT " ", PRIMARY KEY (`result_id`))")
...
cursor.executemany("INSERT INTO announced_pu_results VALUES(?, ?, ?, ?, ?, ?, ?);",records2)"""

#cursor.execute("CREATE TABLE lga ( uniqueid int(11), lga_id int(11), lga_name varchar(50), state_id int(50), lga_description text, entered_by_user varchar(50), date_entered datetime, user_ip_address varchar(50), PRIMARY KEY (uniqueid))")
...
cursor.executemany("INSERT INTO lga VALUES(?, ?, ?, ?, ?, ?, ?, ?);",records3)
"""

"""cursor.execute("CREATE TABLE party ( id int(11), partyid varchar(11), partyname varchar(11), PRIMARY KEY (id))")
...
cursor.executemany("INSERT INTO party VALUES(?, ?, ?);",records4)


cursor.execute("CREATE TABLE polling_unit (uniqueid int(11), polling_unit_id int(11), ward_id int(11), lga_id int(11), uniquewardid int(11), polling_unit_number varchar(50) DEFAULT " ", polling_unit_name varchar(50) DEFAULT " ", polling_unit_description text, lat varchar(255) DEFAULT " ", long varchar(255) DEFAULT " ", entered_by_user varchar(50) DEFAULT " ", date_entered datetime DEFAULT " ", user_ip_address varchar(50) DEFAULT " ", PRIMARY KEY (`uniqueid`))")


records5 = [
(8, 6, 8, 17, 181, 'DT1708006', 'Sapele Ward 8 PU _', "", '5.59371889', '5.999311165', "", "", ""),
...
cursor.executemany("INSERT INTO polling_unit VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",records5)
"""
PU= input("Filter by announced polling unit result.\nParty abbreviation: ").upper()
cursor.execute("SELECT * FROM announced_pu_results WHERE party_abbreviation= :PU", {'PU': PU})
agentname= cursor.fetchall()
print(agentname)
conn.commit()
conn.close()
...
print()
print()
clear= input("Clear screen and proceed(yes or no)?").lower()
if clear == "yes":
    time.sleep(1)
    os.system("clear")
    print("Sorting our table by polling unit per lga")
    conn= sqlite3.connect('interview.db')
    cursor = conn.cursor()
    cursor.execute("SELECT lga.lga_id, lga.lga_name, polling_unit.polling_unit_name, polling_unit.lga_id, polling_unit.polling_unit_id FROM lga INNER JOIN polling_unit on lga.lga_id = polling_unit.lga_id")
    agentname= cursor.fetchall()
    print(agentname)
    conn.commit()
    conn.close()
